package com.mess.loader.hook.application;
...
public class ApplicationHook {
    ...
    private static void preloadMeta(String apkFilePath) {
        try {
            ...
            if (mAppMetaData != null && mAppMetaData.containsKey("application")) {
                delegateApplicationName = mAppMetaData.getString("application");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
